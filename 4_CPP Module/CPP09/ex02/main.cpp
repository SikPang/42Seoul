...
/*   Updated: 2023/05/31 22:17:37 by kwsong           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
이 연습의 유효성을 검사하려면 코드에 적어도 두 개의 서로 다른 컨테이너를 사용해야 합니다. 프로그램에서 최소 3000개의 다른 정수를 처리할 수 있어야 합니다.
...
• 세 번째 줄에는 양의 정수 시퀀스를 정렬하는 데 사용되는 첫 번째 컨테이너를 지정하여 알고리즘에 사용된 시간을 나타내는 명시적 텍스트를 표시해야 합니다.
• 마지막 줄에 양의 정수 시퀀스를 정렬하는 데 사용되는 두 번째 컨테이너를 지정하여 알고리즘에 사용된 시간을 나타내는 명시적 텍스트를 표시해야 합니다.
정렬을 수행하는 데 사용된 시간의 표시 형식은 무료이지만 선택한 정밀도를 통해 사용된 두 용기 간의 차이를 명확하게 확인할 수 있어야 합니다.
